...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?= ucwords($data_head['title']) ?> | Administrator Hashfield</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
           ...
           <div style="font-weight:bold; text-align:center; font-size:24px;">Hashfield</div>
               <div style="font-size:12px; font-weight:bold; color:#fff; text-align:center">Dashboard</div>
