                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <label>Title</label>
                                    <input required type="text" name="i_name" class="form-control" placeholder="feature title" value="<?= @$data['data_name'] ?>" title="Fill  title"/>
                                			</div>
                                          
                                         <div class="form-group">
                                            <label>Description</label>
                                           <textarea id="editor" name="i_desc" rows="10" cols="80">
                                            <?php
                                            echo @$data['data_desc']
                                            ?>
                                        </textarea>
